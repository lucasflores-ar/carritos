...
-- 1) Crear usuarios en Authentication -> Users (invitar por email).
-- 2) Dar de alta al/los admin:
--    insert into public.perfiles (user_id, rol) values ('UUID-DEL-USUARIO', 'admin');
-- 3) Vincular cada voluntario con su usuario:
--    update public.voluntarios set user_id = 'UUID-DEL-USUARIO' where id = 'VOL-01';
-- 4) Completar telefono, email y link_maps (quedaron null: no se leian completos en las capturas).
-- ============================================================
